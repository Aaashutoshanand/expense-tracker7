...
if(choice ==1):
    ...
    input("Enter the expense category(food,travel,makeup,books):")
    description=input("Enter a short description:")
    amount=flot(input("enter the amount:"))
...
if (choice==2):
    if (len(expensesList)==0):
        ...
        for eachExpenses in expensesList:
            print(f"Expense No.{count}->{eachExpense['date'],{eachExpense['category']},{eachExeense['description']},Amount:{eachExpenses['amount']}}")
            count=count+1
